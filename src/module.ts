...
import { MyOnlineProtocol, MY_ONLINE_PROTOCOL_MAINNET_NETWORK } from './protocol-online'
...
class MyModule implements AirGapModule {
    ...
    createOnlineProtocol(identifier: string, networkOrId?: string | ProtocolNetwork): Promise<AirGapOnlineProtocol | undefined> {
        const network = "mainnet"/* get the network configuration based on `networkOrId` */
